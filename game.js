...
function displayCompImg(uniqueNumber){
    ...
    if(randomNumber === 2){
        compImg.src = "https://github.com/Saranya2024/rock-paper-scissors-boilerplate/blob/main/assets/rock-hand.png?raw=true";
        compImg.classList.add("size");
    }else if(randomNumber == 3){
        compImg.src = "https://github.com/Saranya2024/rock-paper-scissors-boilerplate/blob/main/assets/paper-hand.png?raw=true";
        compImg.classList.add("size");
    }else if(randomNumber == 1){
        compImg.src = "https://github.com/Saranya2024/rock-paper-scissors-boilerplate/blob/main/assets/scissors-hand.png?raw=true";
        compImg.classList.add("size");
    }
...
function rockfunction(){
    let uniqueNumber = 1;
    youImg.src = "https://github.com/Saranya2024/rock-paper-scissors-boilerplate/blob/main/assets/rock-hand.png?raw=true";
...
function paperfunction(){
    let uniqueNumber = 2;
    youImg.src = "https://github.com/Saranya2024/rock-paper-scissors-boilerplate/blob/main/assets/paper-hand.png?raw=true";
    youImg.classList.add("size");
    displayCompImg(uniqueNumber);
}
...
function scissorsfunction(){
    let uniqueNumber = 3;
    youImg.src = "https://github.com/Saranya2024/rock-paper-scissors-boilerplate/blob/main/assets/scissors-hand.png?raw=true";
    youImg.classList.add("size");
    displayCompImg(uniqueNumber);
}
